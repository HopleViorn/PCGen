...
def sample(eval_args):
    ...
    surfPos_model.load_state_dict(torch.load('proj_log/deepcad_ldm_surfpos/surfpos_epoch_100.pt'))  
    ...
    for batch_idx in range(batch_size):
        ...
        save_points_and_lines_as_ply(surf_wcs_cad, os.path.join(save_folder, f'{savename}'), bboxes=surf_pos_cad)
